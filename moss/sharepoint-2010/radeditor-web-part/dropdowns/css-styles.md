...
slug: moss/sharepoint-2010/radeditor-web-part/dropdowns/css-styles
tags: css,styles
published: True
position: 5
---
...
The CSS class dropdown of RadEditor displays all classes defined in the page or from external CSS files. The dropdown is populated from the __CssClasses__Collection. By default RadEditor for SP2010 uses the same CSS files as the default rich-text editor. Those files are __HtmlEditorTableFormats__.__css__ and __HtmlEditorCustomStyles.css,__ which are located in the following folder:
