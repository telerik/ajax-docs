...
slug: moss/sharepoint-2007-(moss)/incorporating-telerik-ui-for-asp.net-ajax-in-sharepoint-websites
...
Alternatively, you can use [RadScriptManager](2EF524B5-D6BE-47BE-9960-01EF7B786F85) ([how to register its handler]({%slug moss/sharepoint-2007-(moss)/deploying-telerik-ui-for-asp.net-ajax%})).
