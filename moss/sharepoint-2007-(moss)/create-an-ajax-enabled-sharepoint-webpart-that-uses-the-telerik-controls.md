...
slug: moss/sharepoint-2007-(moss)/create-an-ajax-enabled-sharepoint-webpart-that-uses-the-telerik-controls
...
* The next step is to deploy Telerik UI for ASP.NET AJAX to the SharePoint server. You can find instructions at[Deploying Telerik UI for ASP.NET AJAX]({%slug moss/sharepoint-2007-(moss)/deploying-telerik-ui-for-asp.net-ajax%})

* To simplify creating, deploying and debugging the web part, we’ll use the ‘Visual Studio extensions for Windows SharePoint Services’. These extensions can be found at the following URLs:For Visual Studio 2005:[http://www.microsoft.com/downloads/details.aspx?FamilyID=3E1DCCCD-1CCA-433A-BB4D-97B96BF7AB63&displaylang=en](http://www.microsoft.com/downloads/details.aspx?FamilyID=3E1DCCCD-1CCA-433A-BB4D-97B96BF7AB63&displaylang=en)For Visual Studio 2008:[http://www.microsoft.com/downloads/details.aspx?familyid=7BF65B28-06E2-4E87-9BAD-086E32185E68&displaylang=en](http://www.microsoft.com/downloads/details.aspx?familyid=7BF65B28-06E2-4E87-9BAD-086E32185E68&displaylang=en)
