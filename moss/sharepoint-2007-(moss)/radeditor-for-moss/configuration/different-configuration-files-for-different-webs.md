...
slug: moss/sharepoint-2007-(moss)/radeditor-for-moss/configuration/different-configuration-files-for-different-webs
...
If you do not know the UID of the SharePoint web, we offer a simple way to get it using RadEditor for MOSS. Look at the following article for more information - [Frequently Asked Questions]({%slug moss/sharepoint-2007-(moss)/radeditor-for-moss/frequently-asked-questions%})
