...
slug: moss/sharepoint-2007-(moss)/radeditor-for-moss/dropdowns/font-sizes
tags: font,sizes
published: True
position: 1
---
...
If you want to apply font sizes in pixels (px) or in points (pt) then use the [Real Font Size]({%slug moss/sharepoint-2007-(moss)/radeditor-for-moss/dropdowns/real-font-sizes%}) dropdown.
