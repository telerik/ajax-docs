...
slug: moss/sharepoint-2007-(moss)/radeditor-for-moss/installation-and-deployment/uninstalling-radeditor
...
1. Revert to the default rich-text editor in Web Content Management scenario (do the reverse actions of the ones described in [Using RadEditor in Web Content Management scenario]({%slug moss/sharepoint-2007-(moss)/radeditor-for-moss/installation-and-deployment/using-radeditor-in-web-content-management-scenario%})).
 ...
 * [Using RadEditor in Web Content Management scenario]({%slug moss/sharepoint-2007-(moss)/radeditor-for-moss/installation-and-deployment/using-radeditor-in-web-content-management-scenario%})
