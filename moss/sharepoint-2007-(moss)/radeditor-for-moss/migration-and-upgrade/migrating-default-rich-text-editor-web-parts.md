...
slug: moss/sharepoint-2007-(moss)/radeditor-for-moss/migration-and-upgrade/migrating-default-rich-text-editor-web-parts
...
1. Place a RadEditor Web Part on its place (as described in [Using the RadEditor WebPart]({%slug moss/sharepoint-2007-(moss)/radeditor-for-moss/installation-and-deployment/using-the-radeditor-webpart%}))
