...
The **Import Bootstrap Theme** functionality is currently in development and with limited capabilities.  In order to take advantage of it you need to upload **config.json** file generate by the [Bootstrap customizer tool](http://getbootstrap.com/customize/). Note that you should map the variables from the **“vars”** object according to the convention below in order to import the bootstrap theme successfully :
