...
Each Telerik control documentation includes a help article, which lists the CSS classes of the control and describes their usage. For example the [RadCalendar CSS class list](F67BCE57-3205-4831-B168-3628E10E1E09) states that "rcWeek is a class applied to the <TR> elements, which contain the column headers (<TH> elements)."
...
[How To Override Styles in a Telerik UI for ASP.NET AJAX' Embedded Skin](http://blogs.telerik.com/dimodimov/posts/08-06-17/how_to_override_styles_in_a_radcontrol_for_asp_net_ajax_embedded_skin.aspx)
