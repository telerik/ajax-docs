...
Up to __Q2 2011 SP1__ the built-in skins were located in the Telerik.Web.UI.dll assembly.

Since __Q3 2011__ the [Built-in skins]({%slug introduction/radcontrols-for-asp.net-ajax-fundamentals/controlling-visual-appearance/overview%}) are located in the __Telerik.Web.UI.Skins.dll assembly__. The only exception is the __Default__ skin which is still in the Telerik.Web.UI.dll assembly.
