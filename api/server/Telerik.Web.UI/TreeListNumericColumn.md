---
title: Telerik.Web.UI.TreeListNumericColumn
page_title: Telerik.Web.UI.TreeListNumericColumn
description: Telerik.Web.UI.TreeListNumericColumn
---
...
Gets or sets a value from the NumericType enumeration indicating the numeric type of the
            RadNumericTextBox rendered in edit mode.
...
An integer value that specifies the number of digits that are displayed after the decimal separator
            in the RadNumericTextBox rendered in edit mode.
...
Created the default column editor for the TreeListNumericColumn.

#### Returns

`Telerik.Web.UI.ITreeListColumnEditor` A TreeListNumericColumnEditor object representing the default column editor.
