---
title: Telerik.Web.UI.GridTextColumnEditor
page_title: Telerik.Web.UI.GridTextColumnEditor
description: Telerik.Web.UI.GridTextColumnEditor
---

# Telerik.Web.UI.GridTextColumnEditor

Base class that introduces the editor of GridBoundColumn. This can be an editor that creates a simple TextBox control, or Rich Text editors, that has a single string property Text.
