...
page_title: Telerik.Web.UI.RadImageButton
description: Telerik.Web.UI.RadImageButton
---

# Telerik.Web.UI.RadImageButton

RadImageButton control provides the features, that ASP.NET: ImageButton controls has.
...
* Telerik.Web.UI.RadImageButton : IJavaScriptConverterProvider
