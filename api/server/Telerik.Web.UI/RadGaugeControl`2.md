---
title: Telerik.Web.UI.RadGaugeControl`2
page_title: Telerik.Web.UI.RadGaugeControl`2
description: Telerik.Web.UI.RadGaugeControl`2
---

# Telerik.Web.UI.RadGaugeControl`2

Base class for the different Gauge controls (RadLinearGauge, RadRadialGauge).
