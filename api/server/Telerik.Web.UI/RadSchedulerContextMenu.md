---
title: Telerik.Web.UI.RadSchedulerContextMenu
page_title: Telerik.Web.UI.RadSchedulerContextMenu
description: Telerik.Web.UI.RadSchedulerContextMenu
---

# Telerik.Web.UI.RadSchedulerContextMenu

A context menu control used with the Telerik.Web.UI.RadScheduler control.

#### Remarks
The RadSchedulerContextMenu object is used to assign context menus to Telerik.Web.UI.RadScheduler appointments. Use the
            		P:Telerik.Web.UI.RadScheduler.AppointmentContextMenus property to add context menus for a Telerik.Web.UI.RadScheduler object. 
...
* Telerik.Web.UI.RadSchedulerContextMenu : IMarkableStateManager, IStateManager
