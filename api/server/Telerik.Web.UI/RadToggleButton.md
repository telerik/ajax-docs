...
page_title: Telerik.Web.UI.RadToggleButton
description: Telerik.Web.UI.RadToggleButton
---

# Telerik.Web.UI.RadToggleButton

RadToggleButton provides toggle functionality to a button, allowing the user to configure different states toggled on each button press or by provided API.
...
* Telerik.Web.UI.RadToggleButton : IJavaScriptConverterProvider
...
Gets or sets the name of the JavaScript function that will be called after the SelectedToggleStateIndex property of the RadToggleButton control is changed.

###  OnClientToggleStateChanging `String`

Gets or sets the name of the JavaScript function that will be called when the SelectedToggleStateIndex property of the RadToggleButton control is about to be changed.
...
Gets the currently selected ToggleState of the RadToggleButton control.

###  SelectedToggleStateIndex `Int32`

Gets or sets the index of the currently selected ToggleState of the RadToggleButton control.
...
###  ToggleStates `ButtonToggleStateCollection`

Gets a collection of ButtonToggleState objects that belong to the RadToggleButton control.
...
Find a RadToggleButton's ToggleState by the value of its Text property
...
Find a RadToggleButton's ToggleState by the value of its Value property
...
#### e `Telerik.Web.UI.ToggleButtonStateChangedEventArgs`
...
Invokes the OnToggleStateChanged methods,
            when the SelectedToggleStateIndex property of the control has changed.
