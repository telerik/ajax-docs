---
title: Telerik.Web.UI.RadNotificationContextMenu
page_title: Telerik.Web.UI.RadNotificationContextMenu
description: Telerik.Web.UI.RadNotificationContextMenu
---

# Telerik.Web.UI.RadNotificationContextMenu

A context menu control used with the Telerik.Web.UI.RadNotification control.
...
Checks whether the provided target ID is already added to the menu

#### Parameters

#### targetID `System.String`

the target ID to be checked

#### Returns

`System.Boolean` true if the target is already added
