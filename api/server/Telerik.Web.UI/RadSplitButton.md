---
title: Telerik.Web.UI.RadSplitButton
page_title: Telerik.Web.UI.RadSplitButton
description: Telerik.Web.UI.RadSplitButton
---

# Telerik.Web.UI.RadSplitButton

RadSplitButton control provides the features, that ASP.NET: Button controls has.
...
* Telerik.Web.UI.RadSplitButton : IJavaScriptConverterProvider
...
Gets the RadContextMenu instance of the SplitButton control.
...
###  OnClientContextMenuItemClicked `RadContextMenu`
...
###  PersistChangesFromContextMenu `RadContextMenu`

Controls wether the Text of a clicked ContextMenu item should become the button's Text.
