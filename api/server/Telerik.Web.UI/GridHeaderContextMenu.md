---
title: Telerik.Web.UI.GridHeaderContextMenu
page_title: Telerik.Web.UI.GridHeaderContextMenu
description: Telerik.Web.UI.GridHeaderContextMenu
---
...
###  FilterNumericBoxFirstCondition `RadNumericTextBox`

Gets the filter numeric box first condition.
...
###  GetColumnNameForHeaderContextFilteringMenu

Gets the column name for header context filtering menu.
