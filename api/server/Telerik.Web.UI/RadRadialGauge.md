...
page_title: Telerik.Web.UI.RadRadialGauge
description: Telerik.Web.UI.RadRadialGauge
---

# Telerik.Web.UI.RadRadialGauge

Telerik RadialGauge control for data visualization.
...
Defines the Pointer settings of the RadialGauge.

###  Pointers `RadialPointer`

Sets multiple pointers.

###  Scale `RadialScale`

Defines the Scale settings of the RadialGauge.
