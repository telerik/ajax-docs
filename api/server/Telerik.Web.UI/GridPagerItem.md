---
title: Telerik.Web.UI.GridPagerItem
page_title: Telerik.Web.UI.GridPagerItem
description: Telerik.Web.UI.GridPagerItem
---
...
Gets or sets the caption for the table pager.
...
Gets or sets the summary for the table pager.
...
###  Paging `GridPagingManager`

Gets the paging manager holding information and providing setup for the  pagging.
...
`System.Web.UI.Control` Returns instance of control which contains grid numeric pager
