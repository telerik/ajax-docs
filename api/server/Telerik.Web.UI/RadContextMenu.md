...
page_title: Telerik.Web.UI.RadContextMenu
description: Telerik.Web.UI.RadContextMenu
---

# Telerik.Web.UI.RadContextMenu

This partial Class describes the client properties and events in RadContextMenu.

#### Remarks
The RadContextMenucontrol is used to display context-aware options for various targets. Those targets
            		are specified through the P:Telerik.Web.UI.RadContextMenu.Targets property. RadContextMenu supports the following targets:
                bullet Telerik.Web.UI.ContextMenuControlTarget - Used to associate a context menu with an ASP.NET Server control. 
            			Accepts the control ID as an argument.
            		Telerik.Web.UI.ContextMenuElementTarget - Used to associate a context menu with an HTML element. Accepts
            			the HTML element id as an argument.
            		Telerik.Web.UI.ContextMenuDocumentTarget - Used to specify document-wide context menu.
            		Telerik.Web.UI.ContextMenuTagNameTarget - Used to associate a context menu with all elements with the specified
