---
title: Telerik.Web.UI.TreeListDateTimeColumn
page_title: Telerik.Web.UI.TreeListDateTimeColumn
description: Telerik.Web.UI.TreeListDateTimeColumn
---
...
###  PickerType `TreeListDateTimeColumnPickerType`

Gets or sets a value from the TreeListDateTimeColumnPickerType enumeration representing the
            type of picker which will be shown in edit mode.

###  MinDate `DateTime`

Gets or sets a DateTime value representing the MinValue setting of the picker control in edit mode.

###  MaxDate `DateTime`

Gets or sets a DateTime value representing the MaxValue setting of the picker control in edit mode.
...
Creates and returns a reference to the TreeListDateTimeColumnEditor of the column.

#### Returns

`Telerik.Web.UI.ITreeListColumnEditor` A TreeListDateTimeColumnEditor object representing the editor of the current column.
