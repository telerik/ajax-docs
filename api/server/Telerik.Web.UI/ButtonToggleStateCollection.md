---
title: Telerik.Web.UI.ButtonToggleStateCollection
page_title: Telerik.Web.UI.ButtonToggleStateCollection
description: Telerik.Web.UI.ButtonToggleStateCollection
---

# Telerik.Web.UI.ButtonToggleStateCollection

A collection of Telerik.Web.UI.ButtonToggleState ButtonToggleStateobjects in a Telerik.Web.UI.RadButton RadButtoncontrol
...
Creates a new ButtonToggleState and adds it to the current ToggleState collection.

#### Parameters

#### text `System.String`

The Text of the ToggleState.
...
Removes an item from the ToggleState collection.

#### Parameters

#### item `Telerik.Web.UI.ButtonToggleState`

The ToggleState to remove.
