---
title: Telerik.Web.UI.PivotGrid.Core.Olap.OlapValueGroupFilter
page_title: Telerik.Web.UI.PivotGrid.Core.Olap.OlapValueGroupFilter
description: Telerik.Web.UI.PivotGrid.Core.Olap.OlapValueGroupFilter
---

# Telerik.Web.UI.PivotGrid.Core.Olap.OlapValueGroupFilter

A Telerik.Web.UI.PivotGrid.Core.Filtering.GroupFilter that filters Telerik.Web.UI.PivotGrid.Core.IGroup s based on their Telerik.Web.UI.PivotGrid.Core.AggregateValue subtotals.
