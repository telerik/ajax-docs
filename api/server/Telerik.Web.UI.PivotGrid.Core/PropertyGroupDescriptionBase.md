---
title: Telerik.Web.UI.PivotGrid.Core.PropertyGroupDescriptionBase
page_title: Telerik.Web.UI.PivotGrid.Core.PropertyGroupDescriptionBase
description: Telerik.Web.UI.PivotGrid.Core.PropertyGroupDescriptionBase
---

# Telerik.Web.UI.PivotGrid.Core.PropertyGroupDescriptionBase

Base class used to group items, provide well known groups, sort and filter the groups for a Telerik.Web.UI.PivotGrid.Core.LocalDataSourceProvider based on the item's P:Telerik.Web.UI.PivotGrid.Core.PropertyGroupDescriptionBase.PropertyName value.
