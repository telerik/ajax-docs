---
title: Telerik.Web.UI.PivotGrid.Core.PropertyFilterDescriptionBase
page_title: Telerik.Web.UI.PivotGrid.Core.PropertyFilterDescriptionBase
description: Telerik.Web.UI.PivotGrid.Core.PropertyFilterDescriptionBase
---

# Telerik.Web.UI.PivotGrid.Core.PropertyFilterDescriptionBase

Report Telerik.Web.UI.PivotGrid.Core.FilterDescription implementation.
...
`System.Object` The value used for filtering.
...
`System.Boolean` True if the  passes the filter; otherwise - false.
