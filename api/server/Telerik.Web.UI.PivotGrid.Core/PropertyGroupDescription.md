---
title: Telerik.Web.UI.PivotGrid.Core.PropertyGroupDescription
page_title: Telerik.Web.UI.PivotGrid.Core.PropertyGroupDescription
description: Telerik.Web.UI.PivotGrid.Core.PropertyGroupDescription
---

# Telerik.Web.UI.PivotGrid.Core.PropertyGroupDescription

Used to group items, provide well known groups, sort and filter the groups for a Telerik.Web.UI.PivotGrid.Core.LocalDataSourceProvider based on the item's P:Telerik.Web.UI.PivotGrid.Core.PropertyGroupDescriptionBase.PropertyName value.
