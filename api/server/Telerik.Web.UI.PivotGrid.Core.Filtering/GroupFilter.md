---
title: Telerik.Web.UI.PivotGrid.Core.Filtering.GroupFilter
page_title: Telerik.Web.UI.PivotGrid.Core.Filtering.GroupFilter
description: Telerik.Web.UI.PivotGrid.Core.Filtering.GroupFilter
---

# Telerik.Web.UI.PivotGrid.Core.Filtering.GroupFilter

A base class for all group filters. For internal use. Please refer to one of the Telerik.Web.UI.PivotGrid.Core.Filtering.SingleGroupFilter or Telerik.Web.UI.PivotGrid.Core.Filtering.SiblingGroupsFilter instead.
