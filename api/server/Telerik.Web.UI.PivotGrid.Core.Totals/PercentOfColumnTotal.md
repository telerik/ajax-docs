---
title: Telerik.Web.UI.PivotGrid.Core.Totals.PercentOfColumnTotal
page_title: Telerik.Web.UI.PivotGrid.Core.Totals.PercentOfColumnTotal
description: Telerik.Web.UI.PivotGrid.Core.Totals.PercentOfColumnTotal
---

# Telerik.Web.UI.PivotGrid.Core.Totals.PercentOfColumnTotal

A Telerik.Web.UI.PivotGrid.Core.Totals.SiblingTotalsFormat that formats each Telerik.Web.UI.PivotGrid.Core.Totals.TotalValue to show the percent of the column total.
...
#### groups `Telerik.Web.UI.PivotGrid.Core.Coordinate`
...
#### aggregateIndex `System.Int32`

The index of the aggregate description we are formatting value for.

#### Returns

`Telerik.Web.UI.PivotGrid.Core.AggregateValue` The formatted value.
