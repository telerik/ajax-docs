---
title: Telerik.Web.UI.PivotGrid.Core.Totals.DifferenceFrom
page_title: Telerik.Web.UI.PivotGrid.Core.Totals.DifferenceFrom
description: Telerik.Web.UI.PivotGrid.Core.Totals.DifferenceFrom
---

# Telerik.Web.UI.PivotGrid.Core.Totals.DifferenceFrom

A Telerik.Web.UI.PivotGrid.Core.Totals.SiblingTotalsFormat that is used for all totals that compute a Telerik.Web.UI.PivotGrid.Core.Totals.TotalValue as a difference from other Telerik.Web.UI.PivotGrid.Core.Totals.TotalValue specified by P:Telerik.Web.UI.PivotGrid.Core.Totals.DifferenceFrom.GroupName .
