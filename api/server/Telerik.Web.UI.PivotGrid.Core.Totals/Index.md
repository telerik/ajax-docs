---
title: Telerik.Web.UI.PivotGrid.Core.Totals.Index
page_title: Telerik.Web.UI.PivotGrid.Core.Totals.Index
description: Telerik.Web.UI.PivotGrid.Core.Totals.Index
---

# Telerik.Web.UI.PivotGrid.Core.Totals.Index

A Telerik.Web.UI.PivotGrid.Core.Totals.SingleTotalFormat that computes the 'Index' for the pivot grouping values. The index is computed by the following formula: (aggregateValue * grandTotalValue) / (rowTotalValue * columnTotalValue).
