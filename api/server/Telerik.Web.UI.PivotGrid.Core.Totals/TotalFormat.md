---
title: Telerik.Web.UI.PivotGrid.Core.Totals.TotalFormat
page_title: Telerik.Web.UI.PivotGrid.Core.Totals.TotalFormat
description: Telerik.Web.UI.PivotGrid.Core.Totals.TotalFormat
---

# Telerik.Web.UI.PivotGrid.Core.Totals.TotalFormat

A base class for all total formats. For internal use. Please refer to one of the Telerik.Web.UI.PivotGrid.Core.Totals.SingleTotalFormat or Telerik.Web.UI.PivotGrid.Core.Totals.SiblingTotalsFormat instead.
