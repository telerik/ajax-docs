---
title: Telerik.Web.UI.PivotGrid.Core.Totals.RunningTotalsIn
page_title: Telerik.Web.UI.PivotGrid.Core.Totals.RunningTotalsIn
description: Telerik.Web.UI.PivotGrid.Core.Totals.RunningTotalsIn
---

# Telerik.Web.UI.PivotGrid.Core.Totals.RunningTotalsIn

A Telerik.Web.UI.PivotGrid.Core.Totals.SiblingTotalsFormat that computes running totals.
            For example if you group by System.DateTime and use Telerik.Web.UI.PivotGrid.Core.Totals.RunningTotalsIn to on that groups the results will show how the values sum up in time.
