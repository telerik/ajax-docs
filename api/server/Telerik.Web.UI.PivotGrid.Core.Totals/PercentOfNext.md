---
title: Telerik.Web.UI.PivotGrid.Core.Totals.PercentOfNext
page_title: Telerik.Web.UI.PivotGrid.Core.Totals.PercentOfNext
description: Telerik.Web.UI.PivotGrid.Core.Totals.PercentOfNext
---

# Telerik.Web.UI.PivotGrid.Core.Totals.PercentOfNext

A Telerik.Web.UI.PivotGrid.Core.Totals.SiblingTotalsFormat that formats each Telerik.Web.UI.PivotGrid.Core.Totals.TotalValue to show the percent of the next sibling.
