---
title: Telerik.Web.UI.PivotGrid.Core.Totals.PercentDifferenceFrom
page_title: Telerik.Web.UI.PivotGrid.Core.Totals.PercentDifferenceFrom
description: Telerik.Web.UI.PivotGrid.Core.Totals.PercentDifferenceFrom
---

# Telerik.Web.UI.PivotGrid.Core.Totals.PercentDifferenceFrom

A base class Telerik.Web.UI.PivotGrid.Core.Totals.SiblingTotalsFormat that is used for all totals that compute a Telerik.Web.UI.PivotGrid.Core.Totals.TotalValue as a difference from other Telerik.Web.UI.PivotGrid.Core.Totals.TotalValue and computes the difference as percent from the previous difference.
