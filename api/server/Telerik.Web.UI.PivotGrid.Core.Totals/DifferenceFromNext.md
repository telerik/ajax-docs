---
title: Telerik.Web.UI.PivotGrid.Core.Totals.DifferenceFromNext
page_title: Telerik.Web.UI.PivotGrid.Core.Totals.DifferenceFromNext
description: Telerik.Web.UI.PivotGrid.Core.Totals.DifferenceFromNext
---

# Telerik.Web.UI.PivotGrid.Core.Totals.DifferenceFromNext

A Telerik.Web.UI.PivotGrid.Core.Totals.SiblingTotalsFormat that compute the difference for each TotalValue from its next sibling.
