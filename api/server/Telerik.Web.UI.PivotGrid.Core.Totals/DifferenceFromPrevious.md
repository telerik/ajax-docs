---
title: Telerik.Web.UI.PivotGrid.Core.Totals.DifferenceFromPrevious
page_title: Telerik.Web.UI.PivotGrid.Core.Totals.DifferenceFromPrevious
description: Telerik.Web.UI.PivotGrid.Core.Totals.DifferenceFromPrevious
---

# Telerik.Web.UI.PivotGrid.Core.Totals.DifferenceFromPrevious

A Telerik.Web.UI.PivotGrid.Core.Totals.SiblingTotalsFormat that compute the difference for each TotalValue from its previous sibling.
