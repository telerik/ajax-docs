---
title: Telerik.Web.UI.PivotGrid.Core.Totals.RankTotals
page_title: Telerik.Web.UI.PivotGrid.Core.Totals.RankTotals
description: Telerik.Web.UI.PivotGrid.Core.Totals.RankTotals
---

# Telerik.Web.UI.PivotGrid.Core.Totals.RankTotals

A Telerik.Web.UI.PivotGrid.Core.Totals.SiblingTotalsFormat that rank totals by sorting the totals using the P:Telerik.Web.UI.PivotGrid.Core.Totals.RankTotals.Comparer and then uses the indices of the Telerik.Web.UI.PivotGrid.Core.Totals.TotalValue s in the sorted list for P:Telerik.Web.UI.PivotGrid.Core.Totals.TotalValue.FormattedValue .
...
`Telerik.Web.UI.PivotGrid.Core.Totals.RunningTotalSubGroupVariation` 
