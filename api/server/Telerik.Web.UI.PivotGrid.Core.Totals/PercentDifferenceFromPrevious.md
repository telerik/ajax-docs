---
title: Telerik.Web.UI.PivotGrid.Core.Totals.PercentDifferenceFromPrevious
page_title: Telerik.Web.UI.PivotGrid.Core.Totals.PercentDifferenceFromPrevious
description: Telerik.Web.UI.PivotGrid.Core.Totals.PercentDifferenceFromPrevious
---

# Telerik.Web.UI.PivotGrid.Core.Totals.PercentDifferenceFromPrevious

A base class Telerik.Web.UI.PivotGrid.Core.Totals.SiblingTotalsFormat that calculate the percent of the difference for each Telerik.Web.UI.PivotGrid.Core.Totals.TotalValue of its previous sibling.
...
* Telerik.Web.UI.PivotGrid.Core.Totals.PercentDifferenceFromBase
* Telerik.Web.UI.PivotGrid.Core.Totals.PercentDifferenceFromPrevious
