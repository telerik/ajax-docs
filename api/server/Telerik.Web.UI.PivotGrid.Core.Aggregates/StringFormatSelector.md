---
title: Telerik.Web.UI.PivotGrid.Core.Aggregates.StringFormatSelector
page_title: Telerik.Web.UI.PivotGrid.Core.Aggregates.StringFormatSelector
description: Telerik.Web.UI.PivotGrid.Core.Aggregates.StringFormatSelector
---

# Telerik.Web.UI.PivotGrid.Core.Aggregates.StringFormatSelector

Provides a way to choose a string format for a Telerik.Web.UI.PivotGrid.Core.PropertyAggregateDescriptionBase .
...
#### aggregateDescription `Telerik.Web.UI.PivotGrid.Core.PropertyAggregateDescriptionBase`

The  for which s a StringFormat is selected.

#### Returns

`System.String` A string format.
