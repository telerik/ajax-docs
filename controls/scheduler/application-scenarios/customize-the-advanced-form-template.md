...
page_title: Customize the Advanced Form Template | UI for ASP.NET AJAX Documentation
description: Customize the Advanced Form Template
slug: scheduler/application-scenarios/customize-the-advanced-form-template
...
9. In __Default.aspx__ handle __OnClientAppointmentDataBound__ like this to apply the selected color to the appointment:
