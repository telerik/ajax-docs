...
3) Before implementing the constructors, we need two helper functions for reading from the XML document.**ReadNextID**() looks up the next appointment ID. 
...
![RadScheduler Scenario Wizard](images/scheduler_scenariowizard1.png)
