...
page_title: WCAG 2.0 and Section 508 Accessibility Compliance | RadListBox for ASP.NET AJAX Documentation
description: WCAG 2.0 and Section 508 Accessibility Compliance
slug: listbox/accessibility-and-internationalization/wcag-2.0-and-section-508-accessibility-compliance
...
RadListBox for ASP.NET AJAX satisfies the requirements of **"Section 508"** for software accessibility, as well as those for **"Level AA"** (in compliance with the **W3C Web Accessibility Guidelines 2.0**).
 ...
 * [WCAG 2.0 and Section 508 Accessibility Compliance](https://demos.telerik.com/aspnet-ajax/listbox/examples/functionality/accessibility/defaultcs.aspx)
