...
Using the server-side API, you can programmatically add, remove, disable, or select items in __RadComboBox__.
...
You can locate by searching on the __Text__ or __Value__ properties. You can retrieve either the index of the item or a reference to the item itself. Use the RadComboBox methods:
