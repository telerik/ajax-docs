...
page_title: Using WebFarm or WebGarden Environment | UI for ASP.NET AJAX Documentation
...
1. Set the __ImageStorageLocation__ property of RadCaptcha to __Session__;
