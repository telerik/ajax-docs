...
The **RadSocialShare** offers two inner tags that are used to declare the list of buttons that are shown to the user. These are the **MainButtons** and **CompactButtons** collections. They both contain the**<telerik:RadSocialButton />** items which are the actual buttons.
