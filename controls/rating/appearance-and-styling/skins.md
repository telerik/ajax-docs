...
To make customizing the appearance of __RadRating__ as easy as possible, these control uses skins. A skin is a set of images and a CSS stylesheet that are applied to the HTML elements which make up the rating control, defining the look and feel.
...
__RadRating__ is installed with a number of predefined skins:
>caption 
