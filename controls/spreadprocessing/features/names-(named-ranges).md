...
page_title: Names (Named Ranges) | UI for ASP.NET AJAX Documentation
description: Names (Named Ranges)
slug: spreadprocessing/features/names-(named-ranges)
...
* The names cannot be cell references such asA1, D$2.
...
Тhe document modelhas support only for Defined Names.
