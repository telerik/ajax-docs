...
Note that unlike the case with [Filtering]({%slug spreadprocessing/features/filtering%}) , you can apply more than one sort condition on one column. In fact, this is what you need to do if you'd like to sort by more than one color.
