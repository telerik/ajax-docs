...
page_title: Add and Remove Worksheets | UI for ASP.NET AJAX Documentation
description: Add and Remove Worksheets
slug: spreadprocessing/working-with-worksheets/add-and-remove-worksheets
...
Adding a new worksheet to a workbook can be easily achieved through its __Worksheets__ collection. The collection exposes an __Add()__ method that does not take arguments and returns the instance of the newly created worksheet. By default worksheets are assigned the first available name in the sequence Sheet1, Sheet2, Sheet3… You can easily change the name of the worksheet through the __Worksheet.Name__ property. More information about renaming a worksheet is available in the [Rename a Worksheet]({%slug spreadprocessing/working-with-worksheets/rename-a-worksheet%}) article.
