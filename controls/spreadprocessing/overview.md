...
{% if site.site_name == 'AJAX' %}![Rad Spread Processing Logo WPF](images/RadSpreadProcessing_Logo_WPF.png){% endif %}{% if site.site_name == 'Silverlight' %}![Rad Spread Processing Logo SL](images/RadSpreadProcessing_Logo_SL.png){% endif %}
