...
The *Formats and Conversion* section contains three separate articles dedicated on each of the format providers and one article that illustrates how to work with the [WorkbookFormatProvidersManager](0baf947a-1400-4ee5-90a9-613d258dc165) class.

# See Also

 * [Activate a Worksheet]({%slug spreadprocessing/working-with-worksheets/activate-a-worksheet%})
