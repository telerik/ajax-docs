...
>caption Figure 3.3: Setting MaxDateGroups to 8 forces selects a higher BaseUnitStep of 6 and keeps the current "Months" BaseUnit. (COMMENT: I think "forces selects" is wrong. Please modify.)
