...
**Example 1**: Creating a chart that has two spline series - **AreaSeries** and**LineSeries**. Spline functionality is enabled by simply setting the **LineAppearance.LineStyle**property of the series to "**Smooth**"
