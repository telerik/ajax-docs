...
**Example 1**:UI elements enabled by default in the **RadMap** control
...
**Example 2**: Disabling the **UI Controls** of the **RadMap**
...
**Example 3**:How to reposition the Map’s UI controls
