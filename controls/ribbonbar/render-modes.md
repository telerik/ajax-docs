---
title: Render Modes
page_title: Render Modes | RadRibbonBar for ASP.NET AJAX Documentation
description: Render Modes
slug: ribbonbar/render-modes
tags: render,modes
published: True
position: 2
---
...
**RadRibbonBar** has two different render modes that can change the actual HTML markup that is rendered. They are exposed via the **RenderMode** property that can have three possible values - **Classic**, **Lightweight** and **Auto**. This functionality was introduced in the **Q2 2015** version.
...
````ASP.NET
<telerik:RadRibbonBar RenderMode="Lightweight" runat="server" ID="RadRibbonBar1"> </telerik:RadRibbonBar>	    
````


A **global setting** in the web.config file that will affect the entire application, unless a concrete value is specified for a **RadRibbonBar** instance:

* Change render mode for all **RadRibbonBar** controls in your application:
