...
slug: button/application-scenarios/use-navigateurl-with-standardbutton-type
 ...
 * [RadButton Validation and Client-side Event Handlers]({%slug button/application-scenarios/radbutton-validation-and-client-side-event-handlers%})
