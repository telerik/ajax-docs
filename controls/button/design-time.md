...
The __Skin__ drop-down displays a list of available [skins]({%slug button/appearance-and-styling/skins%})that you can apply to your control, along with an example of what the __RadButton__ control looks like for each skin.Assign a skin by selecting the one you want from the list.
