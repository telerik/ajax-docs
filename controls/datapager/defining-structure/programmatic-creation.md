...
If you want to put a __RadDataPagerTemplatePageField__ inside, you should create a class implementing the __ITemplate__ interface and assign it as a __PagerTemplate__ of the field.
