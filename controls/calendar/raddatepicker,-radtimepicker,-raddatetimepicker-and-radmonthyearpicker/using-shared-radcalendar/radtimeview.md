...
3. In the code behind, create an instance of the shared **RadCalendar** and/or **RadTimeView** object, setting its properties to configure it. Remember that this instance does not inherit any properties from the **RadDatePicker**, **RadTimePicker** or **RadDateTimePicker** controls that use them.
