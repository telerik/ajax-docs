...
|  **Control**  |  **Attributes**  |
| ------ | ------ |
| **RadTreeList** |aria-grabbedaria-dropeffectaria-levelaria-checkedaria-hiddenaria-haspopuprole:button (on pager)Enabled Aria for inner controls (where supported) in column editors etc.|
