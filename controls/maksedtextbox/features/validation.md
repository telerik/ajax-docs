...
````ASPNET
<telerik:RadMaskedTextBox ID="RadMaskedTextBox1" runat="server" EmptyMessage="Enter username">
</telerik:RadMaskedTextBox>
<telerik:RadMaskedTextBox ID="RadMaskedTextBox2" runat="server" EmptyMessage="Enter password">
</telerik:RadMaskedTextBox>
