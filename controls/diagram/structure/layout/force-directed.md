...
page_title: Force-directed | UI for ASP.NET AJAX Documentation
...
RadDiagram does not offer any force-directed specific subtypes. The result of this layout depends on the values configured to the LayoutSettings’ __Iterations__	and __NodeDistance__ properties. You can find information about these properties in the [Layout Basics]({%slug diagram/structure/layout/overview%})	article.
