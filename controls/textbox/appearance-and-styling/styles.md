...
All four types of **RadInput** controls come with a set of predefined styles, which are specified by the styles in the current [skin]({%slug radtextbox/appearance-and-styling/skins%}). If you have assigned a value to the **Skin** property, you can use a variety of style properties to customize the way the input control changes its appearance depending on its state.
 ...
 * [HTML Output and CSS Styling]({%slug radtextbox/appearance-and-styling/html-output-and-css-styling%})
