---
title: Render Modes
page_title: Render Modes | RadTextBox for ASP.NET AJAX Documentation
description: Render Modes
slug: textbox/mobile-support/render-modes
tags: render,modes
published: True
position: 0
---
...
**RadTextBox** has two different render modes that can change the actual HTML markup that is rendered.	They are exposed via the **RenderMode** property that can have hour possible values - **Classic**, **Lightweight**, **Auto** and **Mobile**.	This functionality was introduced in the **Q1 2015** version.
