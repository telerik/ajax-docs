...
page_title: RadToolBarItem Object | RadToolBar for ASP.NET AJAX Documentation
...
The **RadToolBarButton**, **RadToolBarDropDown**, and **RadToolBarSplitButton** objects share most of the same methods. The following table lists the most important of these common **RadToolBarItem** client-side object methods:
...
>caution This method is not available for **RadToolBarButton** .
>
|
