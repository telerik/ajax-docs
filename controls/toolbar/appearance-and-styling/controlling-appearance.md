...
There are a number of ways you can customize the look & feel of your __RadToolBar__ control:
...
* Set the __Orientation__ property to specify whether the toolbar is horizontal or vertical.

* Use the __dir="rtl"__ attribute to give the toolbar a [right-to-left orientation]({%slug toolbar/appearance-and-styling/rtl-support%}).
