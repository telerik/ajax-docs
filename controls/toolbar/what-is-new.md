...
* [Bug fixes](http://www.telerik.com/products/aspnet-ajax/whats-new/release-history/q3-2009-sp2-version-2009-3-1314-2367038387.aspx)
...
* Performance Optimizations on the Server - With Q3 release ASP.NET AJAX introduces [performance optimizations on the server](http://blogs.telerik.com/tsvetomirtsonev/posts/09-10-15/radcontrols_for_asp_net_ajax_-_now_with_more_speed.aspx). By deleting reflection code we have achieved up to 30% improvements depending on the scenario.
