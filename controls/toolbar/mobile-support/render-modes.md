---
title: Render Modes
page_title: Render Modes | RadToolBar for ASP.NET AJAX Documentation
description: Render Modes
slug: toolbar/mobile-support/render-modes
tags: render,modes
published: True
position: 2
---
...
**RadToolBar** has two different render modes that can change the actual HTML markup that is rendered. They are exposed via the **RenderMode** property that can have three possible values - **Classic**, **Lightweight** and **Auto**. This functionality was introduced in the **Q2 2015** version.
...
````ASP.NET
<telerik:RadToolBar RenderMode="Lightweight" runat="server" ID="RadToolBar1"> </telerik:RadToolBar>	    
````


A **global setting** in the web.config file that will affect the entire application, unless a concrete value is specified for a **RadToolBar** instance:

* Change render mode for all **RadToolBar** controls in your application:
...
````ASP.NET
<appSettings>
    <add key="Telerik.Web.UI.ToolBar.RenderMode" value="lightweight" />
</appSettings>
````
