...
page_title: TileCollection Object | UI for ASP.NET AJAX Documentation
...
The __Telerik.Web.UI.TileList.TileCollection__ object exposes the following public methods and properties to control its behavior:
