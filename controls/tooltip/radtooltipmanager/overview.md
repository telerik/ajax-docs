---
title: RadToolTipManager Overview
...
* When a list of elements should be tooltipified. In this case the [RadToolTipManager TargetControls]({%slug tooltip/radtooltipmanager/using-the-targetcontrols-collection%})____collection should be used. This scenario allows for finer tuning. You can use more than one __RadToolTipManager,__each configured for a specific set of controls.
