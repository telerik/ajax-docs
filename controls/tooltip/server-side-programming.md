...
page_title: Server-side Programming | RadTooltip for ASP.NET AJAX Documentation
...
| Name | Description |
| ------ | ------ |
| **Show** |Shows the tooltip. NOTE - The event is actually available for the manager, too but do not documented it because it might cause unexpected behavior;|
