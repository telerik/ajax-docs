...
1. Define the __CloudUpload__ and set Amazon as a __ProviderType__.
...
1. Add a new __CloudUpload__ control with __ProviderType__ Amazon and set the __HttpHandlerUrl__ property.
