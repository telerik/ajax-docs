...
* Add the following style in the head tag of your ASPX:
...
* Set the ExpandMode property of the panelbar control to FullExpandedItem;

* Set Height="100%" in the definition of the panelbar control
