---
title: Setting Focus
page_title: Setting Focus | RadDateInput for ASP.NET AJAX Documentation
...
The client-side objects for all the **RadInput** controls have a **focus** method that lets you set focus to the control. The following example uses this method to set focus to a **RadDateInput** control when the page is loaded, by calling its focus method from the BODY **onload** event:
