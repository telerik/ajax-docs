...
<body class="body">
	...
	<telerik:RadDateInput RenderMode="Lightweight" ID="RadDateInput1" runat="server" EnableEmbeddedSkins="false" Skin="">
...
For more information on the *CSS* File structure, see [Understanding the Skin CSS File]({%slug raddateinput/appearance-and-styling/html-output-and-css-styling%}).
