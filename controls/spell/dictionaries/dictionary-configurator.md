...
![](images/spell_conf_3.gif)Wordlists should follow the same import format as custom dictionaries, e.g. the imported text files, should have one word per line with no leading or trailing whitespaces.
