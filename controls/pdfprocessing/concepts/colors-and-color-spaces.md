...
page_title: Colors and Color Spaces | UI for ASP.NET AJAX Documentation
...
__Example 1__ demonstrates how you can create an RgbColor and assign it as Fill of a [](27ec198e-2554-45dc-81cb-957a87f84004) element.
...
__Example 2__ shows hot to create a LinearGradient and assing it as the FillColor of a [FixedContentEditor]({%slug pdfprocessing/editing/fixedcontenteditor%}).
...
Since the __TilingBase__ class implements the __IContentRootElement__ interface like [](c26b1511-7f04-4793-8997-ed882ef015bf), the content of the tiling can be modified using the __FixedContentEditor__ class. __Example 3__ shows how a tiling pattern can be created:
...
# See Also[](27ec198e-2554-45dc-81cb-957a87f84004)
