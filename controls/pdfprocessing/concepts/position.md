---
title: Position
page_title: Position | UI for ASP.NET AJAX Documentation
...
>tip You can find a diagram representing the structure in __RadPdfProcessing__ [here]({%slug pdfprocessing/model%}).
>
