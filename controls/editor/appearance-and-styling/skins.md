...
**RadEditor**uses **skins** to control its overalllook-and-feel. A skin is a set of images and a CSS stylesheet that can be applied to the control elements (items, images, etc.) and defines their look and feel. The **RadEditor**skin affects the appearance of dialogs as well.

To apply a skin to a **RadEditor**control, set its **Skin**property, either using the properties pane or the Smart Tag.

**RadEditor** is installed with a number of preset skins. These are shown below:![radeditor-skins](images/radeditor-skins.png)
