...
>caption Example 2: Showing and hiding the RadEditor control dynamically.
...
>caption Example 3: Moving the RadEditor in different DOM elements.
...
The solution for this problem is to attach a handler to the resize event of the window object, which implements logic that invokes the **repaint()** method. **Example 4** provides an example of such a scenario and the workaround.

>caption Example 4: Setting the Width property in percent.
