---
title: Skins
page_title: Skins | RadNumericTextBox for ASP.NET AJAX Documentation
description: Skins
...
For more information on the *CSS* File structure, see [Understanding the Skin CSS File]({%slug numerictextbox/appearance-and-styling/html-output-and-css-styling%}).

# See Also

 * [Styles]({%slug numerictextbox/appearance-and-styling/styles%})
