---
title: Fields
page_title: Fields | UI for ASP.NET AJAX Documentation
description: Fields
slug: wordsprocessing/concepts/fields/fields
tags: fields
published: True
position: 0
---
...
Here is how simple page field looks like inside the document:![Rad Words Processing Concepts Fields 01](images/RadWordsProcessing_Concepts_Fields_01.png)
...
* *switches*: One or several additional properties of the field. The syntax of a switch is the following:*\switch-character [switch-argument]*
...
Below is an example of field code:![Rad Words Processing Concepts Custom Code Field 01](images/RadWordsProcessing_Concepts_CustomCodeField_01.png)
 ...
 * [Document model]({%slug wordsprocessing/model%})[](e9cceb62-be40-480b-bc34-8a37c8d985e5)
