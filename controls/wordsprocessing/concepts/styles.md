...
__RadFlowDocument__ includes repository of [Styles](http://www.telerik.com/help/wpf/allmembers_t_telerik_windows_documents_flow_model_styles_style.html) objects which contain sets of character, paragraph or table [style properties]({%slug wordsprocessing/concepts/style-properties%}). They provide rich editing capabilities with consistent look over different content inside the document. Styles allow formatting properties to be stored and managed independently from the content. [](dd4dbe18-3a7a-4b31-a1e4-2b2ff6fba91e) keeps its styles in __StyleRepository__ object accessible through the __RadFlowDocument.StyleRepository__ property.
...
* __Character styles__: Used to contain properties of a [](9fefa02d-b368-4d24-a6fd-5047712117fb) such as: font style, font size, font family, font-weight, etc. Styles of this type contain only __CharacterProperties__> set of style properties.

* __Paragraph styles__: Used to contain properties of a [](9d9b69ad-e25d-4dbf-b9ff-704390594da5) such as: text alignment, spacing (before and after), indentation, etc. Styles of this type contain __ParagraphProperties__ and __CharacterProperties__ sets of style properties, where character properties are used to format the __Runs__ inside the styled __Paragraph__.

* __Table styles__: Used to contain properties of a [](7f0b60cb-ecf1-4994-ba91-e979d1af4c8c) and table-related document elements ([](a37388da-0cc1-4529-9697-02e745cdb720) and [](3d0bef98-f1d1-433d-a1d8-240c2a8e771b) ), such as borders, background, alignment, padding, etc. Styles of this type contain __TableProperties__, __TableRowProperties__, __TableCellProperties__, __ParagraphProperties__ and __CharacterProperties__ sets of style properties, where table row and table cell properties are used to format child __TableRows__ and __TableCells__, paragraph and character properties are used to format the __Paragraphs__ and __Runs__ in the styled table.

* __Numbering styles__: Used to represent a [Lists]({%slug wordsprocessing/concepts/lists%}) in the user interface of an application. Style with this type cannot be referenced directly by document elements. It holds only information about the associated list.
 ...
 * [Styles API Reference](http://www.telerik.com/help/wpf/allmembers_t_telerik_windows_documents_flow_model_styles_style.html)[](dd4dbe18-3a7a-4b31-a1e4-2b2ff6fba91e)[](9fefa02d-b368-4d24-a6fd-5047712117fb)[](9d9b69ad-e25d-4dbf-b9ff-704390594da5)[](7f0b60cb-ecf1-4994-ba91-e979d1af4c8c)
