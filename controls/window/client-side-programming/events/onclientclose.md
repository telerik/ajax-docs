...
You can use this event to [return data from the dialog page](https://demos.telerik.com/aspnet-ajax/window/examples/dialogreturnvalue/defaultcs.aspx) and to create parent-child relationships with other RadWindow instances.
