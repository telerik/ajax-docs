...
{% if site.site_name == 'Silverlight' %}![ziplibrary sl icon](images/ziplibrary_sl_icon.png){% endif %}{% if site.site_name == 'AJAX' %}![ziplibrary wpf icon](images/ziplibrary_wpf_icon.png){% endif %}
