...
__RadDataForm__ provides built-in support for automatic CRUD operations thus allowing you toinsert/update/delete records using very little code. In order to take advantage of this functionalityyou should configure the control as follows:

1. Bind it to a __DataSource__ control that supports automatic data source operations.

1. Add the primary key field from the database table as a __DataKeyName__.
