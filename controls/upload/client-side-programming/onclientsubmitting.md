...
The **OnClientSubmitting** client-side event occurs when apostback that uploads files is about to occur.
...
The following example uses the **OnClientSubmitting** event to prevent thepostback if the files to upload are invalid:
