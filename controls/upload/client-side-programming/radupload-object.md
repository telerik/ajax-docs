...
page_title: RadUpload Object | UI for ASP.NET AJAX Documentation
...
The following table lists the important __RadUpload__ client-side methods:
...
| clearFileInputAt | integer | none | Clears the file input area in the specified (0-based) row. This method is useful for clearing allinputs in response to a cancel button, or clearing invalid inputs. |
| ------ | ------ | ------ | ------ |
