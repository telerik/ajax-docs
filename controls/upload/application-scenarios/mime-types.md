---
title: Mime-Types
page_title: Mime-Types | UI for ASP.NET AJAX Documentation
description: Mime-Types
slug: upload/application-scenarios/mime-types
tags: mime-types
published: True
position: 8
---
...
Different browsers serve different MIME types for the same files. For example, .JPG files are uploadedwith __image/pjpeg__ mime-type when using IE and __image/jpeg__,when using Firefox.

>note  __RadUpload__ does not determine the mime-type using only the file extension. For exampleif you try to upload a text file that has the extension ".JPG", it is still uploaded with text/plain mime-type.
>
