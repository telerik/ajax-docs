...
page_title: How to Place the Submit Button Inside the Upload Container | UI for ASP.NET AJAX Documentation
description: How to Place the Submit Button Inside the Upload Container
slug: upload/application-scenarios/how-to-place-the-submit-button-inside-the-upload-container
