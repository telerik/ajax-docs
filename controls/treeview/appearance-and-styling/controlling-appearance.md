...
To adjust the font sizes of all items in the RadTreeView, you should use the following CSS rule:
...
The declaration above increases the font size by 3px (since the default font size of the RadTreeView is 11px).

## Changing the spacing between tree Nodes

To change the space between the RadTreeView Nodes, you should use the following CSS rules:
...
The Node lines of the RadTreeView can be adjusted by modifying the following lines:
