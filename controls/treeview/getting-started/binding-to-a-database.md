...
page_title: Binding to a Database | RadTreeView for ASP.NET AJAX Documentation
...
1. In the "Test Query" page of the wizard, click the **Finish** button to close the wizard. The Access Data Source component will be created automatically and assigned to the RadTreeView **DataSourceID** property
