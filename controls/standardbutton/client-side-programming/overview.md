...
````JavaScript
var button = $telerik.findButton("<%= RadStandardButton1.ClientID %>");
````
...
| **.add_checkedChanging()** |The name of the javascript function called when the Checked property of the RadStandardButton control is about to be changed.|
| **.remove_checkedChanging()** |Removes a handler for the checkedChanging event.|
| **.add_checkedChanged()** |The name of the javascript function called after the Checked property of the RadStandardButton control is changed.|
| **.remove_checkedChanged()** |Removes a handler for the checkedChanged event.|
| **.add_toggleStateChanging()** |The name of the javascript function called when the SelectedToggleStateIndex property of the RadStandardButton control is about to be changed.|
| **.remove_toggleStateChanging()** |Removes a handler for the toggleStateChanging event.|
| **.add_toggleStateChanged()** |The name of the javascript function called after the SelectedToggleStateIndex property of the RadStandardButton control is changed.|
...
| **.get_checked()** |Gets a bool value indicating whether the RadStandardButton control is checked.|
| **.set_checked()** |Sets a bool value indicating whether the RadStandardButton control is checked.|
| **.get_buttonType()** |Gets the type of the button.|
| **.get_toggleType()** |Gets the toggle type of the RadStandardButton when used as a toggle button.|
| **.get_target()** |Gets the target window or frame in which to display the Web page content linked to when the RadStandardButton control is clicked.	This property is specific for a **RadStandardButton** configured as a **LinkButton** ( **ButtonType="LinkButton"** ).|
| **.set_target()** |Sets the target window or frame in which to display the Web page content linked to when the RadStandardButton control is clicked.	This property is specific for a **RadStandardButton** configured as a **LinkButton** ( **ButtonType="LinkButton"** ).|
| **.get_navigateUrl()** |Gets the URL to link to when the RadStandardButton control is clicked.	This property is specific for a **RadStandardButton** configured as a **LinkButton** ( **ButtonType="LinkButton"** ).|
| **.set_navigateUrl()** |Sets the URL to link to when the RadStandardButton control is clicked.	This property is specific for a **RadStandardButton** configured as a **LinkButton** ( **ButtonType="LinkButton"** ).|
...
| **.get_toggleStates()** |Gets a collection of RadStandardButtonToggleState objects that belong to the RadStandardButton control.|
| **.get_selectedToggleState()** |Gets the currently selected ToggleState of the RadStandardButton control when used as a custom toggle button.|
| **.get_selectedToggleStateIndex()** |Gets the index of the currently selected ToggleState of the RadStandardButton control, when used as a custom toggle button.|
| **.set_selectedToggleStateIndex()** |Sets the index of the currently selected ToggleState of the RadStandardButton control, when used as a custom toggle button.|
| **.get_groupName()** |Gets the name of the group that the RadStandardButton of ToggleType=Radio, belongs to.|
...
**RadStandardButtonToggleState**

| Properties | Description |
| ------ | ------ |
| **.get_index()** |Gets the 0-based index of the ToggleState object in the ToggleStates collection.|
| **.get_text()** |Gets the text displayed in the RadStandardButton control.|
| **.get_cssClass()** |Gets the CSS class applied to the RadStandardButton control.|
| **.get_hoveredCssClass()** |Gets the CSS class applied to the RadStandardButton control when the mouse pointer is over the control.|
| **.get_pressedCssClass()** |Gets the CSS class applied to the RadStandardButton control when the control is pressed.|
| **.get_height()** |Gets the height of the RadStandardButton control.|
| **.get_width()** |Gets the width of the RadStandardButton control.|
...
| **.get_primaryIconTop()** |Gets the top edge of the Primary Icon, relative to the RadStandardButton control's wrapper element.|
| **.get_primaryIconLeft()** |Gets the left edge of the Primary Icon, relative to the RadStandardButton control's wrapper element.|
| **.get_primaryIconBottom()** |Gets the bottom edge of the Primary Icon, relative to the RadStandardButton control's wrapper element.|
| **.get_primaryIconRight()** |Gets the right edge of the Primary Icon, relative to the RadStandardButton control's wrapper element.|
...
| **.get_secondaryIconTop()** |Gets the top edge of the Secondary Icon, relative to the RadStandardButton control's wrapper element.|
| **.get_secondaryIconLeft()** |Gets the left edge of the Secondary Icon, relative to the RadStandardButton control's wrapper element.|
| **.get_secondaryIconBottom()** |Gets the bottom edge of the Secondary Icon, relative to the RadStandardButton control's wrapper element.|
| **.get_secondaryIconRight()** |Gets the right edge of the Secondary Icon, relative to the RadStandardButton control's wrapper element.|
...
| **.get_imageUrl()** |Gets the location of an image to display in the RadStandardButton control.|
| **.get_hoveredImageUrl()** |Gets the location of an image to display in the RadStandardButton control, when the mouse pointer is over the control.|
| **.get_pressedImageUrl()** |Gets the location of an image to display in the RadStandardButton control, when the control is pressed.|
