...
If the **Skin** property is set, transparency is applied by default from the skin. However you can change this behaviour by setting **EnableSkinTransparency="false"**.
...
You can find more information about **RadAjaxLoadingPanel** skins [here]({%slug ajax/appearance-and-styling/skins%}).
