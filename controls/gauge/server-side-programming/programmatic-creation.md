...
>caption Figure 1: Programmatically created Gauge

![gauge-programmatic-creation](images/gauge-programmatic-creation.png)

>caption Example 1: The code that renders the result from Figure 1.
