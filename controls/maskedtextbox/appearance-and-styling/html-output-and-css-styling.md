...
page_title: HTML Output and CSS Styling - RadMaksedTextBox
...
See the [CSS Skin File Selectors]({%slug radmaskedtextbox/appearance-and-styling/css-skin-file-selectors%}) topic for more information on the specific CSS selectors used for **RadInput** skins.
