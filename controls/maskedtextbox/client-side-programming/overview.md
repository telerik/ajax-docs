...
>tip In addition to the methods listed above, which are present in the client-side object for all the RadInput controls, the **RadMaskedTextBox** has additional methods for getting the value. See and [RadMaskedTextBox Client Object]({%slug radmaskedtextbox/client-side-programming/radmaskedtextbox-client-object%}) for details.
>
