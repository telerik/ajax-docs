...
* [Databinding]({%slug chart/building-radcharts/data-binding-radchart%}) - RadChart can be databound to various datasources and provides API for fine-tunning the data-binding mechanism.
...
* [Logarithmic Y Axis](http://demos.telerik.com/aspnet-ajax/Chart/Examples/NewFeatures/LogarithmicAxis/DefaultCS.aspx) makes it easy to show data of different order in a single graph.
