---
title: Bezier Charts
page_title: Bezier Charts | UI for ASP.NET AJAX Documentation
...
To create a simple vertical Bezier Chart set the SeriesOrientation property to __Vertical__. Set the RadChart DefaultType property or ChartSeries.Type to __Bezier__. Create a series and add four chart items with X and Y values.
...
To create a simple horizontal Bezier Chart set the SeriesOrientation property to __Horizontal__. Set the RadChart DefaultType property or ChartSeries.Type to __Bezier__. Create a series and add four chart items with X and Y values.
