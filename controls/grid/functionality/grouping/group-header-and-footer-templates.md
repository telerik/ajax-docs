...
>tip When grouping by a **GridCalculatedColumn** 's values, you should access the totals using the field name with the string *"Result"* appended to it, e.g. if the column name is "TotalPrice", you should access AggregatesValues ["TotalPriceResult"] in order to get the total.
>
