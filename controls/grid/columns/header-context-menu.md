...
[ This online demo ](https://demos.telerik.com/aspnet-ajax/grid/examples/columns-rows/columns/context-menu/defaultcs.aspx) illustrates how to use a header context menu in RadGrid for ASP.NET AJAX. It is quite useful if you would like to process operations like sorting or grouping on a per-column basis or show/hide some of the grid columns based on the end user's preferences.
...
For more information on RadGrid header filtering menu, see the live example [here](https://demos.telerik.com/aspnet-ajax/Grid/Examples/GeneralFeatures/HeaderContextFilterMenu/defaultcs.aspx).
