...
RadGrid comes with a built-in functionality for exporting its content to PDF: [PDF Export]({%slug grid/functionality/exporting/pdf-export %}). This works great, however, in some cases, one would like to customize the PDF content further and change properties other than the RadGrid provides.
...
- [RadGrid PDF Export]({%slug grid/functionality/exporting/pdf-export%})
