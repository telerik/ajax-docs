...
__The Telerik UI for ASP.NET AJAX submenu is missing and only the “About” option is available under the Telerik menu.__
...
* Start a Visual Studio Command Prompt (*Start menu -> Microsoft Visual Studio 20xx -> Visual Studio Tools -> Visual Studio 20xx Command Prompt*);![Visual Studio 2012 Command Prompt](images/introduction-vsx_troubleshooting_vsprompt.png)
...
* Select Telerik [Product] VSExtensions and press Uninstall button![Uninstalling extension](images/introduction-vsx_troubleshooting_uninstall_extension.png)
