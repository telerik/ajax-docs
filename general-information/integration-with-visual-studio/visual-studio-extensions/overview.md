...
Visual Studio Extensions for Telerik UI for ASP.NET AJAX are distributed with the Telerik UI for ASP.NET AJAX installer. They can be downloaded and install as separate product from the Visual Studio Gallery only for Visual Studio 2010 and later.The extensions support Visual Studio 2008, Visual Studio 2010, Visual Studio 2012, Visual Studio 2013 and Visual Studio 2015 handling.NET 3.5, .NET 4.0 and .NET 4.5 projects.
