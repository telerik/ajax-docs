...
* Ensure that only **one version** of the **Telerik.Web.UI** assembly is referenced throughout the whole Sharepoint application. Also in **GAC**, **IIS Sharepoint Bin** folder and the **web.config**
...
* Inspect the HTML content of the designer and ensure that all inner conrols are loaded as expected
...
* If you are seeing the following error make sure that Telerik.Web.UI.dll is present only in one of the folders
