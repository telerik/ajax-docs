...
The information below provides details about the second approach. **Still, we strongly recommend following points 1 to 3(inclusive) from the "uninstall Telerik RadEditor from your SharePoint 2013 site" section, when uninstalling the controls via the MS Windows Control Panel applet**.
