...
description: Learn how to apply Telerik skins in ASP.NET themes for consistent and customizable control styling.
...
>Note that Internet Explorer is unable to handle more than 31 CSS files on a page. If the ASP.NET theme contains more CSS files, you must combine them in some way, otherwise some of them will not be applied at all. In order to combine embedded CSS files, you can use [RadStyleSheetManager](https://www.telerik.com/products/aspnet-ajax/documentation/controls/stylesheetmanager/overview).
>
