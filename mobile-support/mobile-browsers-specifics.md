...
* __Mobile Safari versions before iOS 6 do not support input elements with type="file"__, so it will be rendered as __disabled__ (hence RadAsyncUpload/RadUpload won’t work).
